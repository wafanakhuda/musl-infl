...
require("../auth/google"); // Ensures Google strategy is registered
...
router.get("/google", (req, res, next) => {
    ...
    if (req.session) {
        req.session.oauth_user_type = userType;
    }
    const authenticateOptions = {
        scope: ["profile", "email"]
    };
    passport_1.default.authenticate("google", authenticateOptions)(req, res, next);
});
// ✅ Enhanced callback with profile completion detection
router.get("/google/callback", (req, res, next) => {
    passport_1.default.authenticate("google", { session: false }, (err, authResult, info) => {
        var _a;
        console.log('🔐 OAuth callback result:', {
            hasError: !!err,
            hasAuthResult: !!authResult,
            hasToken: !!(authResult === null || authResult === void 0 ? void 0 : authResult.token),
            userType: (_a = authResult === null || authResult === void 0 ? void 0 : authResult.user) === null || _a === void 0 ? void 0 : _a.user_type
        });
