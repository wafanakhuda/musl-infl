...
export default function BrandLoginPage() {
  ...
  const handleAppleLogin = () => {
    // Redirect to Apple OAuth with brand user type
    window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/apple?user_type=brand`
  }
        ...
        <Card className="w-full max-w-md bg-black/40 backdrop-blur-md border-white/10">
          <CardHeader className="text-center space-y-2">
            ...
            <p className="text-sm text-slate-400">
              Continue with your email or social login
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-black/40 text-slate-400">Or continue with email</span>
              </div>
            </div>
            ...
            <div className="text-center space-y-4">
              <Link
                href="/auth/forgot-password/brand"
